 ...
 */
@Entity
@Table(databaseId = "ICE", name = "ice_disease_vers_concept_rel")
@JndiReference(root = "mts-ejb-ice")
@Permission(name = "ICE Disease Version Concept Relationship", isListed = false)
public class IceDiseaseVersionConceptRelDTO extends BaseDTO {

    private static final long serialVersionUID = 5692239289860895989L;

    public interface ByDiseaseId {
    ...
    @GeneratedValue(source = GenerationSource.FOREIGN_CONSTRAINT, sourceClass = IceDiseaseDTO.class)
