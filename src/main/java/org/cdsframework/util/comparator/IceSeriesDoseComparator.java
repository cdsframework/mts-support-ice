 ...
 */
public class IceSeriesDoseComparator implements Comparator<IceSeriesDoseDTO> {

    @Override
    public int compare(IceSeriesDoseDTO o1, IceSeriesDoseDTO o2) {
        if (o1 == null && o2 == null) {
            return 0;
        }
        if (o1 == null && o2 != null) {
        ...
        if (o1.getDoseNumber() == null && o2.getDoseNumber() == null) {
            return 0;
        }
        if (o1.getDoseNumber() == null && o2.getDoseNumber() != null) {
            return -1;
        ...
        return o1.getDoseNumber().compareTo(o2.getDoseNumber());
    }
}